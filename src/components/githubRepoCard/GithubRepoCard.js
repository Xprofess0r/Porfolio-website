      ...
      <Fade bottom duration={2000} distance="40px">
        <div key={repo.id}>
          ...
          <div className="repo-name-div">
            ...
            <span className="repo-arrow" style={{ color: theme.imageHighlight }}>↗</span>
          </div>

          {/* Description - visually distinct */}
          <p className="repo-description" style={{ color: theme.secondaryText }}>
            {repo.description}
          </p>

          {/* Footer: date + languages */}
          <div className="repo-details">
            <p
              ...
              style={{
                ...
                border: `1px solid ${theme.imageHighlight}33`,
              }}
            >
